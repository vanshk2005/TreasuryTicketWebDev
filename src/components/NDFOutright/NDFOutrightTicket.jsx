...
const NDFOutrightTicket = ({ activeSubTab, mirrorTrades, disableOffMkt, addToast, addTrade, updateTradeStatus, draftDataToLoad, setDraftDataToLoad }) => {
  // Core config fields
  ...
  useEffect(() => {
    if (draftDataToLoad && draftDataToLoad.type === 'NDF') {
  ...
  const handleActionClick = (actionName) => {
    if (actionName === 'Commit') {
      ...
      if (addToast) addToast(`${actionName} action performed on NDFOutrightTicket`, 'info');
    }
  };
        ...
        <div className="form-section glass">
          <div className="param-table" style={{ gridTemplateColumns: '40px 100px 150px 150px 100px 150px 150px' }}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '2px'}}>
              ...
              <div style={{display: 'flex', gap: '5px', alignItems: 'center'}}>
                <label className="custom-checkbox"><input type="checkbox" /><div className="checkbox-box"></div></label>
                <input type="date" value={fixingDate} onChange={handleDataChange(setFixingDate)} style={{width: '100%'}}/>
              </div>
            </div>
            <div style={{display: 'flex', flexDirection: 'column', gap: '2px'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '2px'}}>
              ...
              <SearchableSelect value={bc} onChange={(e) => setBc(e.target.value)}><option value="Foil">Foil</option></SearchableSelect>
            </div>
          </div>
