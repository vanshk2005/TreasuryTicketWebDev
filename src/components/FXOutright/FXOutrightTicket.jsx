...
const FXOutrightTicket = ({ activeSubTab, mirrorTrades, disableOffMkt, addToast, addTrade, updateTradeStatus, draftDataToLoad, setDraftDataToLoad }) => {
  ...
  const [counterparty, setCounterparty] = useState('Client X');
  const [tradingBook, setTradingBook] = useState('FX_BOOK_1');
      ...
      <form onSubmit={(e) => e.preventDefault()} className="ticket-form">
        ...
        <div className="form-section glass">
          <div className="param-table">
            ...
            <div className="param-table-header">Sell Ccy</div>
            <div className="param-table-header">Amount</div>
            <div className="param-table-header">Fx Rate</div>
            <div className="param-table-header">Buy Ccy</div>
            <div className="param-table-header">Amount</div>
          ...
          <div className="param-bottom-controls">
            <label className="custom-checkbox">
