...
const FreeCashTicket = ({ activeSubTab, mirrorTrades, disableOffMkt, addToast, addTrade, updateTradeStatus, draftDataToLoad, setDraftDataToLoad }) => {
  // Core config fields
  ...
  const handleActionClick = (actionName) => {
    if (actionName === 'Commit') {
      ...
      if (addToast) addToast(`${actionName} action performed on FreeCashTicket`, 'info');
    }
  };
      ...
      <form onSubmit={(e) => e.preventDefault()} className="ticket-form">
        ...
        <div className="form-section glass">
          <div className="param-table" style={{ gridTemplateColumns: '100px 200px 100px 150px 150px 1fr' }}>
            ...
            <SearchableSelect value={ntrmReg} onChange={(e) => setNtrmReg(e.target.value)}>
